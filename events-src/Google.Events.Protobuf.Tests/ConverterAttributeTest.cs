...
namespace Google.Events.Protobuf.Tests
{
    public class ConverterAttributesTest
    {
        ...
        {
            var pairs = typeof(ProtobufCloudEventDataConverter<>).Assembly.GetTypes()
            ...
            Assert.All(pairs, pair =>
            {
                ...
                var expectedConverter = typeof(ProtobufCloudEventDataConverter<>).MakeGenericType(new[] { messageType });
