...
namespace OpenFunction.Hosting
{
    internal static class HostingInternals
    {
        ...
        internal static IApplicationBuilder ConfigureApplication(WebHostBuilderContext context, IApplicationBuilder app, bool validateStartups)
        {
            ...
            string logCategory = typeof(EntryPoint).FullName ?? "OpenFunction.Hosting.EntryPoint,OpenFunction.Hosting";
        ...
        internal static IServiceCollection AddServicesForFunctionTarget(IServiceCollection services, Type functionType)
        {
            ...
            else if (GetGenericInterfaceImplementationTypeArgument(functionType, typeof(ICloudEventFunction<>)) is Type payloadType)
            {
                ...
                services
                    ...
                    .AddSingleton(provider => formatter ?? throw new ArgumentNullException());
            }
            else
            {
