...
namespace Google.Cloud.Functions.Invoker
{
    ...
    public class FunctionsApplicationConfigurerAttribute : Attribute
    {
        /// <summary>
        /// 
        /// </summary>
        public Type ConfigurerType { get; set; }
        ...
        /// </summary>
        /// <param name="configurerType">The Type of the <see cref="FunctionsApplicationConfigurer"/> class to register.</param>
        public FunctionsApplicationConfigurerAttribute(Type configurerType) =>
