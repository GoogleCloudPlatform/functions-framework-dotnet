...
namespace Google.Cloud.Functions.Invoker
{
    ...
    internal sealed class FunctionsFrameworkOptions
    {
        ...
        internal static FunctionsFrameworkOptions FromContext(WebHostBuilderContext context) =>
            context.Configuration.GetSection(ConfigSection).Get<FunctionsFrameworkOptions>();
    }
}
