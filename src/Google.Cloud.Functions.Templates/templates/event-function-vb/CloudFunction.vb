...
Imports Google.Cloud.Functions.Framework.GcfEvents
...
Public Class CloudFunction
    Implements ICloudEventFunction(Of StorageObject)
    ...
    Public Function HandleAsync(cloudEvent As CloudEvent, data As StorageObject, cancellationToken As CancellationToken) As Task _
        Implements ICloudEventFunction(Of StorageObject).HandleAsync
